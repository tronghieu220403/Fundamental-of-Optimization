...
if(a.SolveHeuristic()==1):
    ...
    print("There exists a solution for default e and f of the teacher's data.",flush=True)
else:
    print("There exists no solution for default e and f of the teacher's data.",flush=True)
    
a.PrintAns("1.out")

print("______________________________________________",flush=True)
print("Now maximize e and f.",flush=True)
...
print(f'Maximize value of e is {StuData[emax]}',flush=True)
print(f'Maximize value of f is {PrfData[fmax]}',flush=True)
